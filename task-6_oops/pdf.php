...
<?php
  ...
  $pdf->Cell(80,10,$_SESSION["firstName"],0,0,'R');
  $pdf->Cell(40,10,$_SESSION["lastName"],0,1,'L');
  $pdf->SetFont('Arial','B',12);
  $pdf->Cell(77.5,10,'Phone number :',0,0,'R');
  $pdf->Cell(6,10,$_SESSION["code"],0,0,'L');
  $pdf->Cell(28,10,$_SESSION["phonenum"],0,1,'C');
  $pdf->Cell(65,10,'Email-ID :',0,0,'R');
  $pdf->Cell(60,10,$_SESSION["emailcheck"],0,1,'L');
  $pdf->Ln(15);
